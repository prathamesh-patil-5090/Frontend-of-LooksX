      ...
      <div className="backdrop-blur-sm bg-[#1A1F2C]/30 p-8 rounded-lg">
        ...
        >
          ...
          <div className="flex gap-4">
            ...
            <button className="bg-white/10 backdrop-blur-sm border-2 border-white px-6 py-2 rounded hover:bg-white/20 transition-all duration-300 text-white font-bold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
              Explore Services
            </button>
          </div>
        </div>
